...
const Footer = () => {
  return (
    <>
      <footer className='h-[300px] md:h-[500px] flex flex-col p-8 text-white items-center bg-zinc-900 font-semibold'>
        <div className='container h-full w-full p-5 md:p-0 bg-black flex flex-col gap-4 justify-center rounded-3xl items-center'>
